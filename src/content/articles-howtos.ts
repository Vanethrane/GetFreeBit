    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "11. Keep a one-page ops note with no seed words: device model, firmware date, companion app version, networks used, backup location codes, and the last successful dust restore. Update it after every firmware change. Advanced passphrase setups: [Hardware Wallet Setup and Passphrase](/guides/hardware-wallet-setup-and-passphrase).",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "11. Once a quarter, red-team yourself: search your wallet brand plus “support,” notice the ads, and close them without clicking. Review connected sites and approvals the same day. Phishing defense is a habit loop—bookmark [RPC Phishing and Transaction Simulation](/guides/rpc-phishing-and-transaction-simulation) and [Spotting Honeypots and Rug Pulls](/guides/spotting-honeypots-and-rug-pulls).",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "11. End each analysis with one written decision (“revoke X,” “stop LP on Y,” “bridge less,” or “no action”). Metrics without decisions are entertainment. Store the decision next to the explorer links you used. Operator reading: [Reading Etherscan Like an Operator](/guides/reading-etherscan-like-an-operator).",
